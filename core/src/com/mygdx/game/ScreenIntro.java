...
public class ScreenIntro implements Screen {
    ...
    public ScreenIntro(MyGdxGame g) {
        ...
        imgBackGround = new Texture("start.jpg");
        btnPlay = new TextButton(mgg.font, "Play", 550, 500);
        btnSettings = new TextButton(mgg.font, "Settings", 550, 400);
        btnAbout = new TextButton(mgg.font, "About", 550, 300);
        btnExit = new TextButton(mgg.font, "Exit", 550, 200);
    }
